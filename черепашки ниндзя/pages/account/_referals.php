...
<div class="silver-bk"><center>Приглашайте в игру своих друзей и знакомых, Вы будете получать 10% от каждого пополнения баланса  
...
Ваша персональная ссылка: <font color="#000;">http://<?=$_SERVER['HTTP_HOST']; ?>/?i=<?=$_SESSION["user_id"]; ?></font>
</center>
<br>
<center>
...
&lt;img src="http://<?=$_SERVER['HTTP_HOST']; ?>/img/min_468х60.gif" /&gt;&lt;/a&gt;
</textarea>
<br>
</center>
<br>

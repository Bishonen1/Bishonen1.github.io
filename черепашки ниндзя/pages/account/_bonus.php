<?PHP
$_OPTIMIZATION["title"] = "Вспомогательный Фонд";
...
?>
<div class="s-bk-lf">
	<div class="acc-title">Вспомогательный Фонд</div>
</div>
<div class="silver-bk">
<div class="clr"></div>
...
<BR />
<center>
Это Вспомогательный Фонд. Здесь можно получать ежедневную помощь на ведение бизнеса. Выдается она серебром на покупки один раз в 24 часа. <BR />
Сумма бонуса генерируется случайно от <b><?=$bonus_min;?></b> до <b><?=$bonus_max;?></b> серебра.</center>
<BR /><BR />
<?PHP
$ddel = time() + 60*60*24;
$dadd = time();
...
<table width="330" border="0" align="center">
  ...
  <tr>
    <td align="center"><input type="submit" name="bonus" value="Получить бонус" style="height: 30px; margin-top:10px;width: 190px;font-size: 13pt; padding: 0 20 0 20;" class="btn_8"></td>
  </tr>
</table>
</form>
  ...
  $db->Query("SELECT * FROM db_bonus_list ORDER BY id DESC LIMIT 20");
	...
	if($db->NumRows() > 0){
		...
		<tr class="htt">
    		...
    		<td align="center"><img src="/img/fruit/serebro.png" width="28" height="28" style=" margin-top: 0px; margin-left: -30px"/><div class="fr-te-gr" style=" margin-top: -24px; margin-left: 30px" /><font color="#914A1F"><?=$bon["sum"]; ?></font></td>

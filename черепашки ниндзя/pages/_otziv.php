...
$_OPTIMIZATION["keywords"] = "Отзывы о http;//ваш сайт.ru";
?>
<div class="s-bk-lf">
   <div class="acc-title">Отзывы</div>
</div>
<div class="silver-bk">Здесь можно оставить свой отзыв о нашем проекте. Можно оставить только 1 отзыв.
<font color="black">

<html>
	<head>
		<title>ЧЕРЕПАШКИ НИНДЗЯ! - {!TITLE!}</title>
...
<center>
<table><tr><td>
<li><a href="#" ><div class="hd-menu li2"><font color = '#0099C5'>.</font></div></a></<li>
...
<li><a href="/payments" id="linkm4"><div class="hd-menu li">Выплаты</div></a></li>
</td><td>
...
<li><a href="/otziv"  ><div class="hd-menu li">Отзывы</div></a></li>
</td><td>
...
<div class="logo"><a href="/"><img src="/img/logo.png" style="width: 220px; height: 85px;"/></a></div>
</div>

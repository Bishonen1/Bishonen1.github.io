...
$_OPTIMIZATION["description"] = "черепашки ниндзя!";
$_OPTIMIZATION["keywords"] = "Заработок на играх, вложения, заработать, черепашки ниндзя, денежная игра, заработать на онлайн играх";
...
@include("inc/_header.php");
		...
		if(isset($_GET["menu"])){
			...
			switch($menu){
				...
				case "help": include("pages/_help.php"); break; // Вопросы
